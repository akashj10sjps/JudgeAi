...
@app.post("/extract", summary="Extract data from a court order PDF")
...
@app.post("/approve", response_model=ApproveResponse, summary="Approve extracted data")
...
@app.get("/dashboard", summary="Get all approved action plans")
async def dashboard():
...
@app.get("/audit/{case_number:path}", response_model=AuditLogResponse,
